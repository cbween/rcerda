...
module EdrAgentTester
  class HttpAgentTester < EdrAgentTester
    # TODO: More methods.
    METHODS = %w[get]
    PORTS = %w[80 443]
    ...
    def run
      ...
      if @method.nil? || @host.nil? || @port.nil?
        raise EdrAgentTesterFailure.new('Method, Domain, and Port are required.')
      end
